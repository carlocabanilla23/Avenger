...
?>
        ...
        <div class="content">
            ...
            <picture>
            <source media="(min-width: 800px)" srcset="../images/captain-america2-medium.jpg" >
			<img src="../images/captain-america2.jpg" alt="captain america 2"/>	
			</picture>
            <h2>Captain America 2: The Winter Soldier</h2>
            ...
            of a new ally, the Falcon. However, they soon find themselves up against an unexpected and formidable enemy—the Winter Soldier.</p>
               ...
               <section id="video-content">
                <h3>Watch Trailer</h3>
                <iframe  
				src="http://www.youtube.com/embed/zAqCbTKbmYI?autoplay=0" allowfullscreen>
				</iframe>
